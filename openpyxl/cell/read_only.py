...
class ReadOnlyCell(object):
    ...
    __slots__ =  ('parent', 'row', 'column', '_value', 'data_type', '_style_id', 'formula')

    def __init__(self, sheet, row, column, value, data_type='n', style_id=0, formula_value=None):
        self.parent = sheet
        self._value = None
        self.row = row
        self.column = column
